...
就像 [cpu_percent()](#psutil.cpu_percent) ，但提供 [psutil.cpu_times(percpu=True)](#psutil.cpu_times) 返回的每个特定 CPU **_时间的利用率百分比。interval_** 和 **_percpu_** 参数的含义与 [cpu_percent()](#psutil.cpu_percent) 中的含义相同。 在 Linux 上，“**guest**”和“**guest\_nice**”百分比不计入“**user**”和“**user\_nice**”百分比。
...
5.4.4 版本中修改: 在Linux中新增了 `slab` 指标。_
